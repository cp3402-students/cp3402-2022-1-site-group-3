...
if ( ! function_exists( 'education_center_social_icons_svg_list' ) ) :    
/**
 * Get SVG Image
*/
function education_center_social_icons_svg_list( $social ){
...
if( ! function_exists( 'education_center_get_image_sizes' ) ) :
	/**
	 * Get information about available image sizes
	 */
	function education_center_get_image_sizes( $size = '' ) {
...
if ( ! function_exists( 'education_center_category' ) ) :
/**
 * Prints categories
 */
function education_center_category(){
    // Hide category and tag text for pages.
    if ( 'post' === get_post_type()) {
        /* translators: used between list items, there is a space after the comma */
        $categories_list = get_the_category();
        echo '<span class="category-list" itemprop="about">';
        foreach( $categories_list as $cat_list ){
            echo '<a href="' . esc_url( get_category_link( $cat_list->term_id ) ) . '">' . $cat_list->name . '</a>';
        }
        echo '</span>';
    }
}
...
if ( ! function_exists( 'education_center_posted_on' ) ) :
/**
...
function education_center_get_fallback_svg( $post_thumbnail ) {
    ...
    $fallback_svg = get_theme_mod( 'fallback_svg', '#b2b2b2' );
...
if ( ! function_exists( 'education_center_posted_by' ) ) :
/**
...
if( ! function_exists( 'education_center_get_id_from_page' ) ) {
    /**
     * Get page ids from page name.
    */
    function education_center_get_id_from_page( $slider_pages ){
        if( $slider_pages ){
            $ids = array();
...
if( ! function_exists( 'education_center_get_svg_icons' ) ) :
/**
 * SVG for social icons
*/
function education_center_get_svg_icons(){    
